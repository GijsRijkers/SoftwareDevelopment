...
public class WaypointEditor
{
    [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected | GizmoType.Pickable)]
        ...
        if(waypoint.nextWaypoint != null){
            ...
            Vector3 _offset = waypoint.transform.right * -waypoint.width / 2f;
            Vector3 _offsetTo = waypoint.nextWaypoint.transform.right * -waypoint.nextWaypoint.width / 2f;

            Gizmos.DrawLine(waypoint.transform.position + _offset, waypoint.nextWaypoint.transform.position + _offsetTo);
        }
